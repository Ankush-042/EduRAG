...
_SYSTEM_PROMPT = (
    ...
    "knowledge. This sentence is not a claim from the context, so it must "
    "never be followed by a citation like [1] or [1, 2, 3, 4] — a citation "
    "means \"this fact came from that passage,\" and this sentence is "
    "saying the opposite, that no passage answered it.\n"
